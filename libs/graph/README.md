...
For examples, see the resolver generators I've written [for
SQLite](https://github.com/jacobobryant/biff/blob/master/libs/sqlite/src/com/biffweb/sqlite/impl/resolver.clj)
and [for
XTDB](https://github.com/jacobobryant/biff/blob/master/libs/xtdb/src/com/biffweb/xtdb/impl/resolver.clj).
